export const appRegistry = [
	...
	{ id: 'apps', title: 'Loja Docker', route: '/apps', icon: '⬢', permissions: ['docker:admin'], window: { width: 1100, height: 720, minWidth: 780, minHeight: 480 } },
	{ id: 'terminal', title: 'Terminal', route: '/terminal', icon: '⌨', permissions: ['terminal:admin'], window: { width: 980, height: 640, minWidth: 720, minHeight: 420 } },
